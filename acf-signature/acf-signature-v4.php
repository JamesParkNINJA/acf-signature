...
class acf_field_signature extends acf_field
{
	...
	*/
	...
	function input_admin_enqueue_scripts()
	{
		...
		#wp_register_script('flashcanvas', $this->settings['dir'] . 'js/libs/flashcanvas.js', '', $this->settings['version']);
		wp_register_script('signaturepad', $this->settings['dir'] . 'js/libs/signature_pad.min.js', '', $this->settings['version']);

		// register acf scripts
		wp_register_script('acf-input-signature', $this->settings['dir'] . 'js/input.js', array('acf-input','signaturepad'), $this->settings['version']);
		$args = array(
			'is_mobile' => wp_is_mobile()
		);
		wp_localize_script('acf-input-signature', 'signature', $args);
		wp_register_style('acf-input-signature', $this->settings['dir'] . 'css/input.css', array('acf-input'), $this->settings['version']);

...
class acf_field_signature extends acf_field {
	...
	*/
	...
	function __construct() {
		...
		*  var message = acf._e('signature', 'error');
		*/

		$this->l10n = array(
			'error'	=> __('Error! Please enter a correct signature', 'acf-signature'),
		);
	...
	function render_field_settings( $field ) {
		...
		*/
		...
		/* acf_render_field_setting( $field, array(
			'label'			=> __('Font Size','acf-signature'),
			'instructions'	=> __('Customise the input font size','acf-signature'),
			'type'			=> 'number',
			'name'			=> 'font_size',
			'prepend'		=> 'px',
		)); */
	...
	*/
	...
	function input_admin_enqueue_scripts() {
		...
		// register & include JS
		wp_register_script( 'acf-input-signature', "{$dir}js/input.js" );
		wp_enqueue_script('acf-input-signature');


		// register & include CSS
		wp_register_style( 'acf-input-signature', "{$dir}css/input.css" );
		wp_enqueue_style('acf-input-signature');
	...
	*/
	...
	function validate_value( $valid, $value, $field, $input ){
		...
		if( $value < $field['custom_minimum_setting'] )
		{
			$valid = __('The value is too little!','acf-signature'),
		}
